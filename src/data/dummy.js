...
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsBookmarkHeartFill } from 'react-icons/bs';
import { BiColorFill, BiMessageSquare } from 'react-icons/bi';
import { IoMdContacts } from 'react-icons/io';
import { RiContactsLine, RiStockLine, RiDiscussFill } from 'react-icons/ri';
import { MdOutlineSupervisorAccount, MdOutlinePostAdd, MdViewList } from 'react-icons/md';
...
export const links = [
  {
    ...
    links: [
      {
        name: 'new_post',
        link: ':username/dashboard/new_post',
        icon: <MdOutlinePostAdd />,
      },
      {
        name: 'categories_management',
        link: ':username/dashboard/category',
        icon: <FiShoppingBag />,
      },
      {
        name: 'posts_management',
        link: ':username/dashboard/posts',
        icon: <MdViewList />,
      },
    ],
  },

  {
    ...
    links: [
      {
        name: 'most_popular_posts',
        link: 'most_popular_posts',
        icon: <FaVoteYea />,
      },
      {
        name: 'most_comment_posts',
        link: 'most_comment_posts',
        icon: <RiDiscussFill />,
      },
    ],
  },
